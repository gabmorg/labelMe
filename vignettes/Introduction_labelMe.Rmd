...
## Within app session
Tracking label proportions is possible in the `Label Proportions` tab of the webapp. Simply navigate to the tab and click `Update` to view the current labeling proportions of your uploaded dataset.
...
If you have another CSV prepared, have a serialized a dataset to analyze, or have already exited the app after data export, you can simply convert the CSV to a dataframe (for example, via `as.data.frame()`) and proceed as above
